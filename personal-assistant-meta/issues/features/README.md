...
| [1.2](resolved/feature-1.2-database-setup/issue.md) | PostgreSQL 数据库集成 | 持久化基础设施（Docker Compose + SQLAlchemy + 表结构） | Feature 1 | backlog |
...
flowchart TD
    ...
    F10 --> F15["Feature 15: Calendar 完整 OAuth2"]
    F4 --> F15
```
