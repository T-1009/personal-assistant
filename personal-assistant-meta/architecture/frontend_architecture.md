...
| 模块 | 稳定职责 |
|------|----------|
| `chat-adapter.ts` | 等待 remote Conversation 初始化，生成唯一 `client_message_id`，编排 invoke/parse/handle |
| `chat-api-client.ts` | 构造 Conversation-aware body、proactive refresh、401/403 fail-closed；不 retry POST |
